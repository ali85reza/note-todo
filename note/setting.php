                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-4"><input type="text" name="title" class="form-control" value="<?php echo $userData['title']; ?>"  placeholder="عنوان اصلی"></div>
                                <div class="col-4"><input type="text" name="subtitle" class="form-control" value="<?php echo $userData['subtitle']; ?>"  placeholder="عنوان فرعی"></div>
                            </div>
